...
dragon::engine::engine(int argc, const char *argv[])
{
...
void dragon::engine::registerMod(std::string baseUri, appInit appConf)
{
...
void dragon::engine::registerPlugin(std::string cmd, pluginInit pluginHandle)
{
  plugins[cmd] = pluginHandle;
}

void dragon::engine::Handle4XX(requestHandle handeler)
{
  router::Handle4XX = handeler;
}

void dragon::engine::Handle5XX(requestHandle handeler)
{
